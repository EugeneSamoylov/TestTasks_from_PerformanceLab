...
public class Main {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        String firstFileName = in.nextLine(); //scan first file name from console
        String secondFileName = in.nextLine(); //scan second file name from console
        in.close();

        BufferedReader reader = new BufferedReader(new FileReader(firstFileName)); //reading first file
        String str;
        ...
        reader = new BufferedReader(new FileReader(secondFileName));  //reading second file
